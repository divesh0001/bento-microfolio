...
const socialLinks = [
  {
    name: "GitHub",
    url: "https://github.com/divesh0001",
    icon: (
  ...
  {
    name: "LinkedIn",
    url: "https://www.linkedin.com/in/diveshsaini/",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    name: "LeetCode",
    url: "https://leetcode.com/u/divesh_saini/",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-col items-center md:items-end">
            <div className="flex space-x-4 mb-4">
              {socialLinks.map((link) => (
                <a
                  key={link.name}
                  href={link.url}
                  className="p-2 bg-neutral-100 rounded-full text-neutral-700 hover:bg-black hover:text-white transition-colors"
            ...
            <div className="text-sm text-neutral-500">
              © {new Date().getFullYear()} Divesh Saini. All rights reserved.
            </div>
          </div>
        </div>
      </div>
